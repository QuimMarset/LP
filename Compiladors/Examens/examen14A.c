...
#endif
{
  ...
  {
  {
    ...
    {
    while ( (LA(1)==TASK) ) {
      task(zzSTR); zzlink(_root, &_sibling, &_tail);
      zzLOOP(zztasp2);
    }
    zzEXIT(zztasp2);
    }
...
#endif
{
  ...
  zzmatch(DIREC); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
  zzmatch(NUM); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
  zzEXIT(zztasp1);
  return;
fail:
...
#endif
{
  ...
  zzMake0;
  {
  zzmatch(EXECUTE); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
...
#endif
{
  ...
  zzMake0;
  {
  exprBoolAnd(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
...
#endif
{
  ...
  zzMake0;
  {
  exprBoolRel(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
